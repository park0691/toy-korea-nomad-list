...
export type Database = {
  ...
  public: {
    Tables: {
      cities: {
        Row: {
          best_season: Database["public"]["Enums"]["season_type"]
          budget: Database["public"]["Enums"]["budget_type"]
          created_at: string
          dislikes: number
          environments: Database["public"]["Enums"]["environment_type"][]
          id: string
          image_alt: string
          likes: number
          name: string
      ...
      votes: {
        Row: {
          ...
          id: string
          user_id: string
          vote_type: Database["public"]["Enums"]["vote_kind"]
        }
        Insert: {
          city_id: string
          created_at?: string
        ...
        Relationships: [
          {
            foreignKeyName: "votes_city_id_fkey"
            columns: ["city_id"]
            isOneToOne: false
